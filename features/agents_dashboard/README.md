...
```shell
python3 app/ap01_firmware.py agents-live-data-low-stack-build \
  --input artifacts/firmware/opt-setting.bin \
  --output artifacts/firmware/ap01-1.0.2_0031-agents-live-data-low-stack.bin \
  --manifest artifacts/build/agents-live-data-low-stack/manifest.json \
  --build-dir artifacts/build/agents-live-data-low-stack/payload \
