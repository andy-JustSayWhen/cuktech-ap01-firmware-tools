...
def build_sync_firmware(
    ...
    *,
    ...
    integration_mode = expected_output_name == OPT_INTEGRATION_OUTPUT_FILENAME
    ...
    if key_callback_symbol != "ap01_agents_key_event":
        raise AgentsDashboardFirmwareError("不得替换原厂一级总键值回调")
