...
EVIDENCE_PATH = "knowledge/AP01-官方固件分析/原厂各页面物理旋钮交互实现.md"
...
PATCHES = (
    PatchDefinition(
        ...
        evidence_note="证据文档第 8.2 节：164 字节处理程序立即同步首尾列表位置",
    ),
    PatchDefinition(
        name="右旋状态挂接",
        ...
        evidence_note="证据文档第 8.2 节：跳转目标为 0xa001b008",
    ),
    PatchDefinition(
        name="左旋状态挂接",
        ...
        evidence_note="证据文档第 8.2 节：跳转目标为 0xa001b05a",
    ),
)
