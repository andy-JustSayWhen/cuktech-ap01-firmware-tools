...
const phases=document.querySelector("#phases"),message=document.querySelector("#message"),details=document.querySelector("#details"),button=document.querySelector("#action"),fileRow=document.querySelector("#file-row"),filename=document.querySelector("#filename"),loginActions=document.querySelector("#login-actions"),loginStart=document.querySelector("#login-start"),loginComplete=document.querySelector("#login-complete"),loginQr=document.querySelector("#login-qr");
let state;
