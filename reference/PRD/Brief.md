...
首先，AI要下载官方最新的固件并且通读。然后，

固件制作这一需求的 MVP，是我们基于官方最新版的固件进行小修小补，而不是全面重写。所谓的小修小补涉及：提供了N个1级页面，其中有一个页面是萌宠宠物形象展示页面，我把这个页面替换为支持用户显示AGENTS的额度情况和Token消耗信息，MVP先以Codex实战，暂不考虑其他AGENTS。
